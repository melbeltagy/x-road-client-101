...
This feature MUST comply with **Project Constitution v1.0.0** (`.specify/memory/constitution.md`):
...
- [ ] **Validation Standards**: Hybrid timing (format on blur, required on submit), placeholders with examples
- [ ] **Security First**: No credential/certificate persistence, http/https URL validation
...
- If any principle cannot be followed, document rationale here with approval authority
- Complexity justification required for deviations (see Complexity Tracking section)
