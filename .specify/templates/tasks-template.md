...
- [Tasks: [FEATURE NAME]](#tasks-feature-name)
  ...
  - [Phase 4: User Story 2 - [Title] (Priority: P2)](#phase-4-user-story-2---title-priority-p2)
    - [Tests for User Story 2 (OPTIONAL - only if tests requested) ⚠️](#tests-for-user-story-2-optional---only-if-tests-requested--1)
  ...
  - [Phase 5: User Story 3 - [Title] (Priority: P3)](#phase-5-user-story-3---title-priority-p3)
    - [Tests for User Story 3 (OPTIONAL - only if tests requested) ⚠️](#tests-for-user-story-3-optional---only-if-tests-requested--2)
...
**Constitution Compliance**: All foundational infrastructure MUST align with project constitution (`.specify/memory/constitution.md`)

Examples of foundational tasks (adjust based on your project and constitution):

- [ ] T004 Setup project structure per constitution tech stack (Java Records, React, TypeScript)
- [ ] T005 [P] Configure MapStruct for DTO conversions (if DTOs needed)
- [ ] T006 [P] Setup validation framework (Jakarta Bean Validation for backend, React Hook Form for frontend)
- [ ] T007 Configure base DTO patterns (Records with validation annotations)
- [ ] T008 Configure error handling and logging infrastructure
- [ ] T009 Setup environment configuration management
- [ ] T010 Verify NO database dependencies added (constitution: no persistence)
- [ ] T011 Setup theme framework (Cosmo with light/dark/system modes if UI feature)
