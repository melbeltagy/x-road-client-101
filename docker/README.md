# X-Road Generic REST Client - Docker Image
...
```bash
docker pull ghcr.io/melbeltagy/x-road-example-restapi-client:latest
...
```bash
docker run -p 8080:8080 --network <ss-network> ghcr.io/melbeltagy/x-road-example-restapi-client:latest
```
...
docker run -p 8080:8080 \
  ...
  ghcr.io/melbeltagy/x-road-example-restapi-client:latest
```
