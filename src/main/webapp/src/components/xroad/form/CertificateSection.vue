...
<template>
  ...
  <CertificateUploadModal
    ...
    :certificate-label="t(`xroad.certificates.${modalState.certificateType === CertificateType.SECURITY_SERVER ? 'securityServerCert' : modalState.certificateType === CertificateType.CLIENT_CERT ? 'clientCert' : 'clientPrivateKey'}`)"
    :certificate-description="t(`xroad.certificates.${modalState.certificateType === CertificateType.SECURITY_SERVER ? 'securityServerCertDescription' : modalState.certificateType === CertificateType.CLIENT_CERT ? 'clientCertDescription' : 'clientPrivateKeyDescription'}`)"
